...
\begin{frame}[plain]\small\frametitle{Transport plans in $\opensimplexon{\Omega_1 \times \Omega_2}$}
 \begin{itemize}
     ...
     \item Define for all $q_1 \in \opensimplexon{\Omega_1}$ and $q_2 \in \opensimplexon{\Omega_2}$
     \begin{equation*}
         \overset{\circ}{\Pi}(q_1,q_2) = \setof{q \in \opensimplexon{\Omega_1 \times \Omega_2}}{X_1 q = q_1,X_2 q= q_2}
     \end{equation*}
 
 \item  $\overset{\circ}{\Pi}$ is the set of positive \emph{transport plans} from $q_1$ to $q_2$. 
